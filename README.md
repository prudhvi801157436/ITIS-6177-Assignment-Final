...
1. Image Statistics
   ...
   - **Ideal Response Status Code**: <span style ="color:green">200 OK</span>
...
1. If the request is missing the `imageUrl` parameter, a <span style="color:#FF7F50"> 400 Bad Request</span> response will be returned.
    ...
    ```
2. If there are any issues either with the request or the response from the Azure Computer Vision API, a <span style="color:red"> 500 Internal Server Error</span> response will be returned.
